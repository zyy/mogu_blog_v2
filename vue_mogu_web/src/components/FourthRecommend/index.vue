<template>
    <div class="tuijian" v-if="fourthData.length > 0">
      ...
      <ul class="tjpic" v-if="fourthData[0]">
        <i>
          <img v-if="fourthData[0].photoList" v-lazy="fourthData[0].photoList[0]" :key="fourthData[0].photoList[0]" style="cursor:pointer"  @click="goToInfo(fourthData[0])">
        </i>
      ...
      <ul class="sidenews">
        <li v-for="item in sideNews" :key="item.uid">
          <i>
            <img style="cursor:pointer" v-if="item.photoList" v-lazy="item.photoList[0]" :key="item.photoList[0]" @click="goToInfo(fourthData[0])">
          </i>
